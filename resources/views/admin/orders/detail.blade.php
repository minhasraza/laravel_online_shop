                    ...
                    <div class="card-header pt-3">
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                ...
                                @elseif($order->status == 'dilivered')
                                <span class="badge text-success">Dilivered</span>
                                @else
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="dilivered" {{ ($order->status == 'dilivered') ? 'selected' : ''
                                        }}>Delivered</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="Shipped Date" type="text" value="{{$order->shipped_date}}"
